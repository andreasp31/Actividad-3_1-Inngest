...
//Los comentarios no los puse casi porque es lo mismo que en SudokuFacil
public class SudokuDificil extends AppCompatActivity {
    ...
    public void enviarPuntacionServidor(){
        ...
        Puntuacion puntuacion = new Puntuacion(nombreJugador,tiempoSegundos,tiempo,"dificil");
