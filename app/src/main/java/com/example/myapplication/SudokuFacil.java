...
public class SudokuFacil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Botones de los números para rellenar el sudoku
        ...
        //donde va a ir el tiempo y el contador de pistas
       ...
       gridView.setOnItemClickListener((parent,view,position,id)->{
        ...
        //En cada hueco de los botones de los números poner los números
    ...
    //Si el tablero es exactamente igual al tablero resuelto ganamos y nos guarda luego todo
    ...
    //Si el tablero está incompleto o mal te permite seguir o abandonar
    ...
    //Alerta que sale cuando le das al botón de pista para darte la pista si quieres o no, pero primero hay que seleccionar  una casilla
    ...
    //Nos da la casilla resuelta para la psita
    ...
    //Esto lo busqué para iniciar el temporizador
