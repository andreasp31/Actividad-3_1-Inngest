...
public class GenerarSudoku {
      ...
      //Crear tablero y con numeros aleatorios
      ...
      //Resetear tablero al acabar  y empezar una partida
      ...
      public void rellenarCaja(int fila, int columna){
          ...
          //Para mezclar más fácil esto lo busqué
      ...
      //Rellenar 3 cajas diagonales porque no crea conflicto para resolver
      ...
      //Comprobaciones de si está correcto el sudoku
