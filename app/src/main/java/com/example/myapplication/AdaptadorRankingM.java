...
public class AdaptadorRankingM extends RecyclerView.Adapter<AdaptadorRankingM.PuntuacionViewHolder> {
    ...
    public AdaptadorRankingM(ArrayList<Puntuacion> listaPuntuacion){
    ...
    public PuntuacionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_adaptador_ranking_m,parent,false);
